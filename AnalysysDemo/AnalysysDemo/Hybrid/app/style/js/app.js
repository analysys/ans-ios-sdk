...
/**
 * [clearSuperProperties description] 获取单个属性后执行的回调函数，且为公共方法
 */
 ...
 * @param  {[type]} superPropertyName [description] 属性名称
 */
function getSuperProperty(superPropertyName) {
    AnalysysAgent.getSuperProperty(superPropertyName, showSuperProperty)
}
/**
 * [clearSuperProperties description] 获取所有通用属性后执行的回调函数，且为公共方法
 */
...
function getSuperProperties() {
    AnalysysAgent.getSuperProperties(showSuperProperties)
}
/**
...
window.onload = function() {
    document.getElementById("uaContext").innerText = navigator.userAgent
}